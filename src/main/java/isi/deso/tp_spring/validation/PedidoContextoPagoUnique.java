...
@Documented
@Constraint(validatedBy = PedidoContextoPagoUnique.PedidoContextoPagoUniqueValidator.class)
public @interface PedidoContextoPagoUnique {

    String message() default "Ya existe ese contexto pago para otro pedido.";
