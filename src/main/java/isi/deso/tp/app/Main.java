...
public class Main {
    ...
    public static void main(String[] args) throws ItemNoEncontradoException {
        ...
        List<Pedido> filtroPorEstadoVendedor1 = vendedorController.buscarPedidosPorEstado(vendedor1.getId(), estadoPedidoAFiltrarVendedor1);
        List<Pedido> filtroPorEstadoVendedor4 = vendedorController.buscarPedidosPorEstado(vendedor4.getId(), estadoPedidoAFiltrarVendedor4);
        ...
        if (!filtroPorEstadoVendedor4.isEmpty()) {
            ...
            vendedorController.actualizarEstado(EstadoPedidoEnum.ENVIADO, filtroPorEstadoVendedor4);
        } else {
            System.out.println("Desde Main: Vacio");
        }
