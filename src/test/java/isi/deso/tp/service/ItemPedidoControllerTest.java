...
public class ItemPedidoControllerTest {
    ...
    public void testCrearItemPedidoSinPrecio() {
        ...
        ItemPedido itemPedido = itemPedidoController.crearItemPedido(1, itemMenu, 2);
    ...
    public void testCrearItemPedidoConPrecio() {
        ItemMenu itemMenu = new Plato(300, true, false, 3, "Flan", "Flan casero con crema", 1000.0, null, 0.5, null);
        ItemPedido itemPedido = itemPedidoController.crearItemPedido(2, itemMenu, 3, 45.0);
    ...
    public void testFiltrarPorVendedor() {
        ...
        lista.add(new ItemPedido(1, i1, 2));
        lista.add(new ItemPedido(2, i2, 3));

        itemPedidoController.setLista(lista);
    ...
    public void testOrdenarPorCantidad() {
        ...
        ItemMenu i2 = new Plato(600, true, false, 3, "Helado", "Flan casero con crema", 1000.0, null, 0.5, v2);
        List<ItemPedido> lista = new ArrayList<>();
        lista.add(new ItemPedido(1, i1, 5));
        lista.add(new ItemPedido(2, i2, 3));
    ...
    public void testDeletePedidoPorId() {
        ...
        ItemPedido itemPedido1 = itemPedidoController.crearItemPedido(3, i1, 1);
        ItemPedido itemPedido2 = itemPedidoController.crearItemPedido(4, i2, 4);
