...
public class Main {
    ...
    public static void main(String[] args) throws ItemNoEncontradoException {
        ...
        Pedido pedido2 = gestorPedido.crearPedido(2, cliente3, listaItemPedido2);
        gestorCliente.agregarPedido(pedido2.getCliente(), pedido2);

        pedido1.setPagoStrategy(new TransferenciaStrategy());
        double precioFinalPedido1 = gestorPedido.aplicarRecargo(pedido1, "45365632", "20-32734242-3");

        gestorPedido.actualizarEstadoPedido(pedido1, EstadoPedidoEnum.RECIBIDO);

        System.out.println("Precio final del pedido con id " + pedido1.getId() + ": " + precioFinalPedido1);

        pedido2.setPagoStrategy(new MercadoPagoStrategy());
        double precioFinalPedido2 = gestorPedido.aplicarRecargo(pedido2, "nachomazzoni.mp");

        gestorPedido.actualizarEstadoPedido(pedido2, EstadoPedidoEnum.RECIBIDO);

        System.out.println("Precio final del pedido con id " + pedido2.getId() + ": " + precioFinalPedido2);
